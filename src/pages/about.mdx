...
Gnosis Research Center (GRC) is directed by Professor Xian-He Sun. In broad sense, it is making some significant moves
in the computer science research, specifically in the area of parallel and cooperated network processing, including
high performance computing, distributed systems, and the newly emerging area of Cloud computing.
