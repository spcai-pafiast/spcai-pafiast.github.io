...
The Scalable Computing Software (SCS) Lab manages several cluster computers to support the group's research.
...
Regular members of the SCS lab enjoy access to the resources. If you wish to gain access to the cluster
...
The SCS lab manages two cluster computers, Ares and HEC, each for different research scope. Our flagship cluster
